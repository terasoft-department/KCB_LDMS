...
<head>
  ...
  <title>KCB-LDMS</title>
    <link rel="icon" href="js/img/kcb.png" type="image/png" sizes="64x64">
...
<nav class="mb-1 navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  <a class="navbar-brand" href="#">
    ...
    <span style="color: #008000;">L</span>egal 
    <span style="color: #008000;">D</span>ocument 
    <span style="color: #008000;">M</span>anagement 
    <span style="color: #008000;">S</span>ystem
  </a>
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-4" data-toggle="dropdown"
          ...
          <span style="color: white;">Welcome!,</span> <?php echo ucwords(htmlentities($id)); ?> <i class="fas fa-user-circle"></i> Login
        </a>
...
<div class="tab-content pt-2 pl-1" id="pills-tabContent">
  ...
  <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
   <h6 style="font-size: 1.1em">LEGAL DOCUMENT MANAGEMENT SYSTEM</h6><Hr>
