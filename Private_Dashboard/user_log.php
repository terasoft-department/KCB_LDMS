...
<head>
  ...
  <title>KCB-LDMS</title>
    <link rel="icon" href="" type="image/jpg" sizes="64x64"><!-- Font Awesome -->
  ...
  $(document).ready(function(){js/img/images.jpg
      $('#dtable').dataTable({
...
<?php } ?>
  ...
  <p>All right Reserved &copy; <?php echo date('Y');?> Created By:Teratech.co.tz</p>
    </div>
    <!--/.Copyright-->
